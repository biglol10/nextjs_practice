...
export default function NavMenu() {
  ...
  console.log(segment); // 현재 layout에 있는 폴더들 표시. 예: compose, biglol, home, 등
  // useSelectedLayoutSegments를 쓰면 ['compose', 'tweet']
  // useSelectedLayoutSegment는 layout.tsx에서 import한 컴포넌트만 쓸 수 있습니다. page.tsx에서 쓰면 무조건 null이 나옵니다.
